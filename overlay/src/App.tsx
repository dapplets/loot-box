...
import CreatedBoxList, { ChildComponent } from './components/createNewBox'
          ...
          <Routes>
            ...
            <Route
              ...
              element={
                (isLoading && <Preloader />) || (
                  <StatisticsNear>
                    <Statistics statistics={statistics} winnersLabelInfo={winnersLabelInfo} />
                  </StatisticsNear>
                )
              }
            />
            <Route
              ...
              element={
                (isLoading && <Preloader />) || (
                  <StatisticsNear>
                    {' '}
                    <Winner winners={winners} winnersLabelInfo={winnersLabelInfo} />
                  </StatisticsNear>
                )
              }
            />
